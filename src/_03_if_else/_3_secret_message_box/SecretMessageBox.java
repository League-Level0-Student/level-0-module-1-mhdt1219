...
public class SecretMessageBox {
	...
	public static void main(String[] args) {
		...
		String input = JOptionPane.showInputDialog("Please enter a secret message!");
		...
		JOptionPane.showMessageDialog(null,
				"You can only see the secret message if you can guess the passcode correctly!");

		// 4. If their guess matches the password, show them the secret message

		String hey = JOptionPane.showInputDialog("Please guess the password!");

		if (hey.equals(password)) {

			JOptionPane.showMessageDialog(null,
					"You have correctly guessed the password! This is the secret message: " + input);
		}
	...
	private static void ellipse(int i, int j) {
